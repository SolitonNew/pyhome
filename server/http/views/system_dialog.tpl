...
<div style="position:relative;background-color:#fff;border: 10px solid #fff;">
    ...
    <TR>
        <TD>
            <div class="group">
                <div>
                    <button onClick="send_query('SCAN_OW', 'OW_STATUS')">Сканировать OneWire устройства</button>
                </div>
                <p>
                При добавлении новых OneWire подчиненных устройств перед их
                использованием необходимо выполнить сканирование сетей.
                После выполнения этой операции все новые устройства будут
                занесены в единую базу и станут доступными для использования
                в сети.<BR>
                <b>Примечание:</b> Эта функция также доступна в окне свойств
                переменной.
                </p>
            </div>
        </TD>
