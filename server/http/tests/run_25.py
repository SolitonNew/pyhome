...
WINTER_GARDEN_R = Variable('WINTER_GARDEN_R', 1.0)
BOILER_R = Variable('BOILER_R', 1.0)
BACK_DOOR_R = Variable('BACK_DOOR_R', 1.0)
...
BEDROOM_3_SECOND_R = Variable('BEDROOM_3_SECOND_R', 1.0)
WC_2_R = Variable('WC_2_R', 1.0)
SHOWER_2_R = Variable('SHOWER_2_R', 1.0)
BEDROOM_3_WC_R = Variable('BEDROOM_3_WC_R', 1.0)
