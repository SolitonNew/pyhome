...
ATTIC_TERM = Variable('ATTIC_TERM', 5.0625)
...
BEDROOM_1_TERM_S = Variable('BEDROOM_1_TERM_S', 20.4375)
BEDROOM_1_TERM_V = Variable('BEDROOM_1_TERM_V', 21.0)
BEDROOM_1_TERM_R = Variable('BEDROOM_1_TERM_R', 0)
BEDROOM_2_TERM_S = Variable('BEDROOM_2_TERM_S', 20.4375)
...
DINING_TERM_S = Variable('DINING_TERM_S', 20.9375)
...
BEDROOM_3_WC_TERM = Variable('BEDROOM_3_WC_TERM', 18.6875)
HEATING_MAIN_OUT = Variable('HEATING_MAIN_OUT', 23.0625)
HEATING_CHIMNEY = Variable('HEATING_CHIMNEY', 20.375)
...
BACK_DOOR_TERM_OUT_S = Variable('BACK_DOOR_TERM_OUT_S', 4.8125)
BOILER_PRESENCE = Variable('BOILER_PRESENCE', 1.0)
