...
ATTIC_TERM = Variable('ATTIC_TERM', 1.3125)
...
BEDROOM_3_TERM_S = Variable('BEDROOM_3_TERM_S', 24.6875)
...
LIVING_TERM_S = Variable('LIVING_TERM_S', 22.5625)
...
BACK_DOOR_TERM_IN_S = Variable('BACK_DOOR_TERM_IN_S', 20.6875)
BEDROOM_3_WC_TERM = Variable('BEDROOM_3_WC_TERM', 24.0)
HEATING_MAIN_OUT = Variable('HEATING_MAIN_OUT', 44.0)
HEATING_CHIMNEY = Variable('HEATING_CHIMNEY', 36.5)
...
BACK_DOOR_TERM_OUT_S = Variable('BACK_DOOR_TERM_OUT_S', 1.0625)
...
STAIRS_TEMP = Variable('STAIRS_TEMP', 24.0)
STAIRS_HUMIDITY = Variable('STAIRS_HUMIDITY', 19.0)
BEDROOM_3_TERM_S2 = Variable('BEDROOM_3_TERM_S2', 26.0)
BEDROOM_3_HUMIDITY_S2 = Variable('BEDROOM_3_HUMIDITY_S2', 29.0)
PODVAL_HUMIDITY = Variable('PODVAL_HUMIDITY', 37.0)
BOILER_CO = Variable('BOILER_CO', 37.6891)
