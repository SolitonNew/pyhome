...
BEDROOM_3_TERM_S = Variable('BEDROOM_3_TERM_S', 22.1875)
...
LIVING_TERM_S = Variable('LIVING_TERM_S', 22.375)
...
BACK_DOOR_TERM_IN_S = Variable('BACK_DOOR_TERM_IN_S', 21.875)
BEDROOM_3_WC_TERM = Variable('BEDROOM_3_WC_TERM', 22.0625)
...
if LIVING_S.value() == 1:
    ...
    WINTER_GARDEN_R.value(LIVING_R.value())
