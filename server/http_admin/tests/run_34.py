...
PODVAL_TERM = Variable('PODVAL_TERM', 8.0)
ATTIC_TERM = Variable('ATTIC_TERM', 5.125)
...
LIVING_TERM_S = Variable('LIVING_TERM_S', 21.6875)
...
DINING_TERM_S = Variable('DINING_TERM_S', 21.875)
...
BEDROOM_3_WC_TERM = Variable('BEDROOM_3_WC_TERM', 23.8125)
HEATING_MAIN_OUT = Variable('HEATING_MAIN_OUT', 43.25)
HEATING_CHIMNEY = Variable('HEATING_CHIMNEY', 34.5625)
...
BACK_DOOR_TERM_OUT_S = Variable('BACK_DOOR_TERM_OUT_S', 4.1875)
...
STAIRS_TEMP = Variable('STAIRS_TEMP', 23.0)
STAIRS_HUMIDITY = Variable('STAIRS_HUMIDITY', 19.0)
BEDROOM_3_HUMIDITY_S2 = Variable('BEDROOM_3_HUMIDITY_S2', 29.0)
PODVAL_HUMIDITY = Variable('PODVAL_HUMIDITY', 52.0)
BOILER_CO = Variable('BOILER_CO', 36.174)
