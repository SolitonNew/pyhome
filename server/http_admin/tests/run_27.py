...
BEDROOM_3_TERM_S = Variable('BEDROOM_3_TERM_S', 20.75)
...
BACK_DOOR_TERM_IN_S = Variable('BACK_DOOR_TERM_IN_S', 20.4375)
BEDROOM_3_WC_TERM = Variable('BEDROOM_3_WC_TERM', 20.5625)
...
ALARM_CLOCK_TIME = Variable('ALARM_CLOCK_TIME', 6.5)
