...
ATTIC_TERM = Variable('ATTIC_TERM', -4.8125)
...
BEDROOM_3_TERM_S = Variable('BEDROOM_3_TERM_S', 22.6875)
...
LIVING_TERM_S = Variable('LIVING_TERM_S', 20.1875)
...
BACK_DOOR_TERM_IN_S = Variable('BACK_DOOR_TERM_IN_S', 17.75)
BEDROOM_3_WC_TERM = Variable('BEDROOM_3_WC_TERM', 21.6875)
HEATING_MAIN_OUT = Variable('HEATING_MAIN_OUT', 48.1875)
HEATING_CHIMNEY = Variable('HEATING_CHIMNEY', 32.9375)
...
BACK_DOOR_TERM_OUT_S = Variable('BACK_DOOR_TERM_OUT_S', -3.4375)
BOILER_PRESENCE = Variable('BOILER_PRESENCE', 0.0)
DAYLIGHT = Variable('DAYLIGHT', 1.0)
BOILER_PRESENCE_OUT = Variable('BOILER_PRESENCE_OUT', 0)
