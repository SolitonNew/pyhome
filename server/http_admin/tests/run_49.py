...
LIVING_TERM_S = Variable('LIVING_TERM_S', 24.875)
...
BACK_DOOR_TERM_IN_S = Variable('BACK_DOOR_TERM_IN_S', 24.6875)
BEDROOM_3_WC_TERM = Variable('BEDROOM_3_WC_TERM', 23.9375)
